...
|-------|------|----------|-------------|----------|
| `prizeType` | String (enum) | Yes (default: 'other') | Type of prize | `'cash'`, `'loyalty'`, `'percentage'`, `'other'` |
| `amount` | String | No (default: '') | Prize amount/details | `'₹500'`, `'30 Loyalty Points'`, `'20% OFF'`, `'Free Dessert'` |
