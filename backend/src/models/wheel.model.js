...
const WheelSchema = new mongoose.Schema(
  {
    ...
    segments: [{
      ...
      // Prize details
      // allow 'percentage' as a prize type as well
      prizeType: { type: String, enum: ['cash', 'loyalty', 'percentage', 'other'], default: 'other' },
    ...
    // centerImageRadius must match the UI constraint (112–120px)
    centerImageRadius: { type: Number, default: 112, min: 112, max: 120 },
    ...
    // New: design section links and line
    instagramUrl: { type: String, default: '', trim: true, maxlength: 500 },
    googleReviewUrl: { type: String, default: '', trim: true, maxlength: 500 },
    youtubeUrl: { type: String, default: '', trim: true, maxlength: 500 },
    designLine: { type: String, default: '', trim: true, maxlength: 200 },
