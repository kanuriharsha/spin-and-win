...
```javascript
{
  ...
  prizeType: "cash",                  // Type: cash/loyalty/percentage/other
  prizeAmount: "₹500",                // Amount/details
  percentageValue: 20,                // % value when prizeType === "percentage"
  computedReward: 100,                // Derived from bill amount and percentage
